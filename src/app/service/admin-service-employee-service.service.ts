...
const WAR = "employee-service";

@Injectable()
export class AdminServiceEmployeeServiceService {
  httpOptions = {
  ...
  // Get Report Keys
  getReportKeys() {
    return this.http.get(`${BASE_URL}/codegen/report/keys`);
  }
  ...
  loadAllCadres() {
    return this.http.get(`${BASE_URL}/${WAR}/employee/cadres`, this.httpOptions);
  }
