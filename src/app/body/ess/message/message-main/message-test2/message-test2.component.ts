...
@Component({
  selector: 'app-message-test2',
  templateUrl: './message-test2.component.html',
  styleUrls: ['./message-test2.component.css']
})
export class MessageTest2Component implements OnInit {
