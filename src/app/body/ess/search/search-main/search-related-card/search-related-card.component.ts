...
@Component({
  selector: 'app-search-related-card',
  templateUrl: './search-related-card.component.html',
  styleUrls: ['./search-related-card.component.css']
})
export class SearchRelatedCardComponent implements OnInit {
  // for UI Responsive
  isMobile = false;
  isTablet = false;
  isDesktop = false;
